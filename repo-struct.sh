...
# get user name
username=`git config --global user.name "koshmikumari"`
#mail_id=`git config --global user.email "misskoshmiyadav@gmail.com"`
if [ "$username" = "" ]; 
then
...
touch README.md
echo 'This is a empty file' >> README.md
echo " done."
...
git remote rm origin                              #remove a remote URL from your repository
